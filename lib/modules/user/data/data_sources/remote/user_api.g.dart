...
class _UserApi implements UserApi {
  ...
  @override
  Future<TokenModel> login(String code, [String type = 'local']) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'code': code, r'type': type};
  ...
  Future<TokenModel> refresh() async {
    final _extra = <String, dynamic>{'_retried': true};
