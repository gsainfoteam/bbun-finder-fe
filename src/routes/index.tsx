...
function MainPage() {
  ...
  return (
    <div className="w-full h-full overflow-y-auto scrollbar-hide overflow-x-hidden">
      <div className="relative min-h-full w-full bg-blue-200 bg-[linear-gradient(162deg,#D2E4FF,#E9E0FF)] flex flex-col justify-start items-center">
        {/* 테스트용 로그아웃 버튼 */}
        <div className="absolute bottom-[40px] z-50">
          <button className="text-gray-400 text-xs" onClick={handleLogoutClick}>
